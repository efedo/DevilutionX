...
std::unique_ptr<TSnd> sound_file_load(std::string_view path, bool stream) { return nullptr; }
tl::expected<std::unique_ptr<TSnd>, std::string> SoundFileLoadWithStatus(std::string_view path, bool stream) { return nullptr; }
TSnd::~TSnd() { }
void snd_init() { }
void snd_deinit() { }
void music_stop() { }
