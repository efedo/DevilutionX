...
tl::expected<Item, std::string> ProjectNativeItem(const protocol::ItemStateSnapshot &state, uint32_t itemSeed, uint32_t price)
{
	Item item;
	item._iSeed = itemSeed;
	...
	item._iIvalue = static_cast<int>(price);
