...
std::string_view LanguageTranslate(std::string_view key) { return key; }
std::string_view LanguagePluralTranslate(std::string_view singular, std::string_view plural, int count) { return count == 1 ? singular : plural; }
