...
void AssertPlayer(Player &player)
{
	...
	ASSERT_EQ(player.attributes.strength.base, 55);
	ASSERT_EQ(player.attributes.strength.current, 124);
	ASSERT_EQ(player.attributes.magic.base, 70);
	ASSERT_EQ(player.attributes.magic.current, 80);
	ASSERT_EQ(player.attributes.dexterity.base, 250);
	ASSERT_EQ(player.attributes.dexterity.current, 281);
	ASSERT_EQ(player.attributes.vitality.base, 80);
	ASSERT_EQ(player.attributes.vitality.current, 90);
	...
	ASSERT_EQ(player.life.maximumBase, 12864);
	ASSERT_EQ(player.life.base, 12864);
	ASSERT_EQ(player.getBaseToBlock(), 20);
	ASSERT_EQ(player.mana.maximumBase, 11104);
	ASSERT_EQ(player.mana.base, 11104);
	...
	ASSERT_EQ(player.life.current, 16640);
	ASSERT_EQ(player.life.maximum, 16640);
	ASSERT_EQ(player.mana.current, 14624);
	ASSERT_EQ(player.mana.maximum, 14624);
