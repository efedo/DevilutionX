...
if(EMSCRIPTEN)
  ...
  if(NOT DEFINED DEVILUTIONX_SYSTEM_ZLIB)
    find_package(ZLIB QUIET)
    if(ZLIB_FOUND)
      message("-- Found ZLIB ${ZLIB_VERSION_STRING}")
    else()
      message("-- Suitable system zlib package not found, will use zlib from source")
...
if(SUPPORTS_MPQ)
  ...
  if(EMSCRIPTEN)
    ...
    if(NOT DEFINED DEVILUTIONX_SYSTEM_BZIP2)
      find_package(BZip2 QUIET)
      if(BZip2_FOUND)
        message("-- Found BZip2 ${BZIP2_VERSION_STRING}")
      else()
        message("-- Suitable system bzip2 package not found, will use bzip2 from source")
...
elseif(USE_SDL3)
  ...
  if(NOT DEFINED DEVILUTIONX_SYSTEM_SDL2)
    find_package(SDL2 QUIET)
    if(SDL2_FOUND)
      message("-- Found SDL2 ${SDL2_VERSION}")
    else()
      message("-- Suitable system SDL2 package not found, will use SDL2 from source")
...
if(PACKET_ENCRYPTION)
  if(WIN32)
    set(_default_system_libsodium OFF)
  else()
    set(_default_system_libsodium ON)
  endif()
  dependency_options("libsodium" DEVILUTIONX_SYSTEM_LIBSODIUM ${_default_system_libsodium} DEVILUTIONX_STATIC_LIBSODIUM)
...
if(BUILD_TESTING)
  if(NOT DEFINED DEVILUTIONX_SYSTEM_GOOGLETEST)
    find_package(GTest QUIET)
    if(GTest_FOUND)
      message("-- Found GTest")
    else()
      message("-- Suitable system googletest package not found, will use googletest from source")
  ...
  if(NOT DEFINED DEVILUTIONX_SYSTEM_BENCHMARK)
    find_package(benchmark QUIET)
    if(benchmark_FOUND)
      message("-- Found benchmark ${benchmark_VERSION}")
    else()
      message("-- Suitable system benchmark package not found, will use benchmark from source")
